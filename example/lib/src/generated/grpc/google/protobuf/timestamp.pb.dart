...
class Timestamp extends $pb.GeneratedMessage with $mixin.TimestampMixin {
  ...
  @$core.override Timestamp clone() => deepCopy();
  @$core.Deprecated(
  'Use rebuild(void Function(Timestamp) updates) instead. '
  'Will be removed in next major version')
  @$core.override Timestamp copyWith(void Function(Timestamp) updates) => rebuild(updates);

  @$core.override $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static Timestamp create() => Timestamp._();
  @$core.override Timestamp createEmptyInstance() => create();
